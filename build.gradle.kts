...
val excludePackages: List<String> by extra {
    listOf(
        "com/kaiqkt/ktresourceserverapi/Application*",
        "com/kaiqkt/ktresourceserverapi/application/config/*",
        "com/kaiqkt/ktresourceserverapi/application/web/requests/*",
        "com/kaiqkt/ktresourceserverapi/application/web/responses/*",
        "com/kaiqkt/ktresourceserverapi/domain/models/*",
        "com/kaiqkt/ktresourceserverapi/domain/dtos/*",
        "com/kaiqkt/ktresourceserverapi/domain/utils/*",
    )
}
